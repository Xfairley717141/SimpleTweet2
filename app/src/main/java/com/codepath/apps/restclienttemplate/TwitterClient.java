...
public class TwitterClient extends OAuthBaseClient {
	...
	//public static final String REST_CONSUMER_KEY = "GkBT1ulvwEfTspPApkOknIgco";
	//public static final String REST_CONSUMER_SECRET = "zTBzPK6gEigQWmPmXv8BUjadoY5bVEYsAI29QCnYRaQdZburT8";
